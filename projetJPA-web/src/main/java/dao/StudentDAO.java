...
public class StudentDAO 
{
	...
	public void addStudent(Student student) //ajout l'̩tudiant dans la BDD
	{ 	
	...
	public List<Student> readStudent(String nom, String prenom) //ajout l'̩tudiant dans la BDD
	{ 	
		EntityManagerFactory emf;
